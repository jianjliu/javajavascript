...
// Test Js.prompt
public final class Prompts extends JsApplet
{
	private static final long serialVersionUID = 6602188721597804199L;

	@Override
	public void onReady() {
		Js.alert(Js.prompt("Input something:"));
		Js.alert(Js.prompt("Input something:", "default input"));
	}
