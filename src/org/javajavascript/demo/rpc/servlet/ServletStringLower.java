...
import org.javajavascript.demo.rpc.server.ServerString;
...
public class ServletStringLower extends HttpServlet
{
	private static final long serialVersionUID = -8562154399274861977L;
			...
			pw.println(
					new XMLHttpServer() {
						...
						protected Object call(ObjectLike base, ArrayLike<?> args) {
							return new ServerString(base).lower();
						}
