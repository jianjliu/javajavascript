...
public abstract class XMLHttpString extends XMLHttpRemote
{
	public final static Index<String> value = new Index<String>(0);

	protected XMLHttpString(ObjectLike o) {
		super(o);
	}
